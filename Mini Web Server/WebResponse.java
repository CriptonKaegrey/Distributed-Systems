...
class WebListenWorker extends Thread {    // Class definition
  Socket sock;                   // Class member, socket, local to ListnWorker.
  WebListenWorker (Socket s) {sock = s;} // Constructor, assign arg s to local sock
  public void run(){
...
public class WebResponse {
  ...
  public static void main(String a[]) throws IOException {
    ...
    while (true) {
      ...
      new WebListenWorker (sock).start();
    }
  }
}
